...
<!-- 分配角色的对话框 -->
<el-dialog
  title="分配角色" :visible.sync="setDialogVisible" width="50%" @close="setRoleDialogClosed">
  <div>
    ...
    return {
      ...
      addFormRules:{
        username:[
          ...
          { required:true, min:3, max:10, message:"用户名的长度在3-10个字符区间", trigger:"blur"}
        ],
        password:[
          { required:true, message:"请输入密码", trigger:"blur"},
          { required:true, min:6, max:15, message:"密码的长度在6-15个字符区间", trigger:"blur"}
        ],
        email:[
